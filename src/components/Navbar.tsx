...
const Navbar = () => {
  ...
  const buttons = [
    {
  link: "https://mail.google.com/mail/?view=cm&fs=1&to=karthik@itjobsemail.com",
  icon: <Mail size={20} />
},
    { link: "https://github.com/karthik5521", icon: <Github size={20} /> },
    { link: "https://www.linkedin.com/in/karthikmajjiga", icon: <Linkedin size={20} /> },
  ];
