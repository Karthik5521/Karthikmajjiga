...
const Footer = () => {
  ...
  const featuredProjects = [
    { name: "Heart Disease Prediction", description: "ML-based diagnosis" },
    { name: "Malaria Detection", description: "Deep Learning app" },
    { name: "Crop Recommendation", description: "Agri ML system" },
    { name: "EasyResume", description: "Resume Builder App" },
  ];
  ...
  const socials = [
    {
      href: "https://github.com/karthik5521",
      icon: <Github size={20} />,
    },
    {
      href: "https://linkedin.com/in/karthikmajjiga",
      icon: <Linkedin size={20} />,
    },
    {
  href: "https://mail.google.com/mail/?view=cm&fs=1&to=karthik@itjobsemail.com",
  icon: <Mail size={20} />,
}
    ...
    <footer className="mt-16 relative z-10 text-gray-800 dark:text-white transition-colors duration-300">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6 max-w-md leading-relaxed">
              Full Stack Developer with a focus on backend services, API
              development, and scalable web applications. Open to backend
              engineering roles, collaborations, and freelance opportunities.
            </p>
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-center gap-3 text-gray-700 dark:text-gray-300">
                <Mail size={18} />
                <a
                  href="mailto:karthik@itjobsemail.com"
                  className="hover:text-indigo-600 dark:hover:text-indigo-400 transition"
                >
                  karthik@itjobsemail.com
                </a>
              </div>
              <div className="flex items-center gap-3 text-gray-700 dark:text-gray-300">
                <MapPin size={18} />
        ...
        <div className="border-t border-gray-300 dark:border-gray-800 mt-12 pt-8 text-sm text-gray-600 dark:text-gray-400 flex flex-col md:flex-row items-center justify-between gap-4 text-center">
          ...
          <span>© {currentYear} Karthik Majjiga</span>
        </div>
